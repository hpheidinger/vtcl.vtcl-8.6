...
distribution file is "tablelist5.15.tar.gz" for UNIX and
"tablelist5_15.zip" for Windows.  These files contain the same
...
the distribution file "tablelist5.15.tar.gz":

    gunzip -c tablelist5.15.tar.gz | tar -xf -

This command will create a directory named "tablelist5.15", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "tablelist5_15.zip" into the directory
"tablelist5.15", with the subdirectories "demos", "doc", and "scripts".
