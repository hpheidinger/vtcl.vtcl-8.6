...
proc vTclWindow.top72 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top +271+376; update
    wm maxsize $top 1284 1006
    wm minsize $top 111 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm deiconify $top
    wm title $top "Message Widget"
    ...
    message $top.mes73 \
        -justify center \
        -text {The message widget can be used to build message boxes.

It displays the text with an aspect ratio that you can specify.

Text can be left justified, centered, or right justified.} 
    vTcl:DefineAlias "$top.mes73" "Message1" vTcl:WidgetProc "Toplevel1" 1
    frame $top.fra75 \
        -borderwidth 2 -height 10 
    vTcl:DefineAlias "$top.fra75" "Frame1" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab74 \
        -background #b45dea3de563 \
        -text {Try playing with the "aspect" option of the message widget.} 
